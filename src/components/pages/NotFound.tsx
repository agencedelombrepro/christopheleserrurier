    ...
    <>
      <section style={{ background: 'var(--navy)', minHeight: '60vh', display: 'flex', alignItems: 'center', padding: '4rem 2.5rem' }}>
        <div style={{ maxWidth: '600px', margin: '0 auto', textAlign: 'center' }}>
          <div style={{ fontFamily: "'Clear Sans',sans-serif", fontSize: '6rem', fontWeight: 800, color: 'var(--orange)', lineHeight: 1 }}>404</div>
          <h1 style={{ fontFamily: "'Clear Sans',sans-serif", fontSize: '1.8rem', color: '#fff', margin: '1rem 0' }}>Page introuvable</h1>
